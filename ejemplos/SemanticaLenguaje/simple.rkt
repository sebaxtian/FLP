  ...
  '((program (expression) a-program)
   ...
   ; (expression
    ; (primitive "(" (separated-list expression ",")")")
     ;primapp-exp)
    (expression ("(" expression primitive expression ")") primitiva-exp)
    (primitive ("+") add-prim)
...
(define apply-primitive
  (lambda (prim args)
    (cases primitive prim
      (add-prim () (funcion args +))
      (substract-prim () (funcion args -))
      (mult-prim () (funcion args *))
...
(define funcion
  (lambda (args op)
    (cond
      ...
      [else (op (car args) (funcion (cdr args) op))]
      )
    )
  )
;*******************************************************************************************
